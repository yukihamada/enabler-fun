...
const faqItems = [
  {
    ...
    answer: "Chef Careerは、料理人のためのキャリアマッチングプラットフォームです。高級店からカジュアル店まで、幅広い求人情報を提供し、経験豊富な料理人とのマッチングやキャリアアップのサポートを行っています。"
  },
  {
    question: "会員登録は無料ですか？",
    answer: "はい、会員登録は完全無料です。登録することで、求人情報の閲覧や応募が可能になります。また、キャリア相談サービスも無料でご利用いただけます。"
  },
  {
    question: "どのような求人情報が掲載されていますか？",
    answer: "高級レストランからカジュアルな飲食店まで、幅広いジャンルの求人情報が掲載されています。和食、洋食、中華、エスニック料理など、様々な料理ジャンルの求人を見つけることができます。また、経験レベルに応じた求人も豊富に用意しています。"
  },
  {
  ...
  },
  {
    ...
    answer: "気になる求人を見つけたら、求人詳細ページの「応募する」ボタンをクリックしてください。履歴書や職務経歴書の提出が必要な場合は、オンラインフォームから簡単にアップロードできます。応募後は、企業からの連絡をお待ちください。"
  },
  {
