...
export default function Dashboard() {
  const { user, error, isLoading } = useUser() as { user: UserProfile | undefined, error: Error | undefined, isLoading: boolean };
        ...
        <section className="py-12">
          ...
          {user && (
            <h2 className="text-3xl mb-4">
              ようこそ、{(user.displayName || user.email || 'ゲスト') as string}さん
            </h2>
          )}
